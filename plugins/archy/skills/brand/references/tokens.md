...
| | Where | Contents |
|---|---|---|
| **Brand** (Paper) | `app.paper.design/file/01M1EY5TFVT7MBV4DRBZXZRR9V` | 95 design tokens. Pages: **Styleguide** (color, themes, type, spacing, layout, components), **Brand Guidelines** (logo, iconography), **Icons** (164 Hugeicons), **Gradients** (the nine pixel-dithered backgrounds and how to use them; generated with the `archy-design:gradients` skill) |
